...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__eco_ext

#else
#  define SWIG_init    init_eco_ext

#endif
#define SWIG_name    "_eco_ext"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_in_2d(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "in_2d", 2, 2, swig_obj)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
  ...
  result = (int)in_2d(arg1,arg2,arg3,arg4,arg5);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "in_2d", _wrap_in_2d, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
